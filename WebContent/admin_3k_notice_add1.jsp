...
<div class="container">     
    ...
    <div class="panel panel-blue panelma width-100%">
        <div class="panel-heading margin-bottom-10">
            <h3 class="panel-title"><i class="icon-tasks"></i>ê³µì§ì¬í­ ë±ë¡</h3>
        </div>
        <div class="container">
...
<!--=== Content Part ===-->  
        ...
        <div class="container">
            <div class="row portfolio-item margin-bottom-10">
                <div class="col-md-12">
                    <button class="btn btn-info">ë±ë¡</button>
                 </div>                     
            </div><!--/col-md-4-->
        </div>
    </div>                             
            ...
            <div class="row">
                <div class="magazine-posts col-md-12 col-sm-6">
                    ...
                    <div class="magazine-posts-img">
                        <a href="#"><img alt="" src="assets/img/main/10.jpg" class="img-responsive"></a>
                ...
                <div class="magazine-posts col-md-12 col-sm-6">
                    ...
                    <span>September 19, 2013</span>
                    <div class="magazine-posts-img">
                        <a href="#"><img alt="" src="assets/img/main/1.jpg" class="img-responsive"></a>
